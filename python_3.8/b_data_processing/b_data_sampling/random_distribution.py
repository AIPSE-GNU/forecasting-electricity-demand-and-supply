...
# C:\Report_github_code\python_3.8\b_data_processing\a_weekend_label_filter\labeled_data

# data load
filtered_data_save_folder_path = '/Report_github_code/python_3.8/b_data_processing/a_weekend_label_filter/labeled_data/'
df = pd.read_csv(filtered_data_save_folder_path + 'after_weekend_filter.csv', index_col=0)
...
for iteration in range(1,6):
    ...
    globals()['sample_{}'.format(iteration)].to_csv(random_sample_save_folder_path + 'RE_demand_sample%i.csv' %iteration)
    a += 17
    b += 17
